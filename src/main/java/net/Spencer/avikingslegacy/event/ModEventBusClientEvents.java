...
import net.Spencer.avikingslegacy.entity.client.Berserk_Model;
...
public class ModEventBusClientEvents {
    ...
    public static void registerLayer(EntityRenderersEvent.RegisterLayerDefinitions event){
        ...
        event.registerLayerDefinition(ModModelLayers.BERSERKER_LAYER, Berserk_Model::createBodyLayer);
    }
}
